...
public class LoginTest extends Base
{
	...
	@Test(retryAnalyzer = Retry.class,description="verifyUserIsAbleToLoginUsingValidCredenials",groups = {"regression"})
	...
	@Test(retryAnalyzer = Retry.class,description="verifyUserIsNotAbleToLoginUsingInvalidUsernameAndPassword")
